    ...
    <div class="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-14">
      ...
      <div>
        ...
        <div class="mt-8 flex gap-4">
          <a href="https://www.instagram.com/gulfcoastiv/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-gold/30 flex items-center justify-center text-ivory/70 hover:text-gold hover:border-gold hover:bg-gold/5 transition-all duration-300">
          ...
          <a href="https://www.facebook.com/profile.php?id=61588985432223" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-gold/30 flex items-center justify-center text-ivory/70 hover:text-gold hover:border-gold hover:bg-gold/5 transition-all duration-300">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
